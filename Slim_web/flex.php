...
?>
  ...
  <div class="containertimer">
    <div class="timer">
      ...
      <img class="timer-background" src="images/timer_1.png" alt="">
      <div class="clock">
        <p class="time" id="timer"><span id="min_1">02</span>:<span id="sec_1">00</span></p>
      </div>  
      <h1 class="identify"><b>VIRABHADRASANA</b></h1>
      
      <!-- <p id="timer"></p> -->
    </div>
    <div class="timer">
      <!-- <h1 class="title">TIMER</h1> -->
      <img class="timer-background" src="images/timer_2.png" alt="">
      <div class="clock">
        <p class="time" id="timer"><span id="min_2">02</span>:<span id="sec_2">00</span></p>
      </div>
       <h1 class="identify"><b>VRKSASANA</b></h1>
      <!-- <p id="timer"></p> -->
    </div>
    <div class="timer">
      <!-- <h1 class="title">TIMER</h1> -->
      <img class="timer-background" src="images/timer_3.png" alt="">
      <div class="clock">
        <p class="time" id="timer"><span id="min_3">02</span>:<span id="sec_3">00</span></p>
      </div>
       <h1 class="identify"><b>NATARAJASANA</b></h1>
      <!-- <p id="timer"></p> -->
    </div>
    <div class="timer">
      <!-- <h1 class="title">TIMER</h1> -->
      <img class="timer-background" src="images/timer_4.png" alt="">
      <div class="clock">
        <p class="time" id="timer"><span id="min_4">01</span>:<span id="sec_4">00</span></p>
      </div>
       <h1 class="identify"><b>PADAHASTASANA</b></h1>
      <!-- <p id="timer"></p> -->
    </div>
